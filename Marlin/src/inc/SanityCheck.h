...
#elif ( !(defined(__AVR_ATmega644P__) || defined(__AVR_ATmega1284P__)) && (!PIN_EXISTS(E0_STEP) || !PIN_EXISTS(E0_DIR) || ( !ENABLED(E0_IS_TMC2660) && !PIN_EXISTS(E0_ENABLE))))
 ...
 */
    ...
    #endif
  #elif E_STEPPERS > 1
    #if !PIN_EXISTS(E1_STEP) || !PIN_EXISTS(E1_DIR) || (!ENABLED(E1_IS_TMC2660) && !PIN_EXISTS(E1_ENABLE))
